...
//	rtPointLight(/*location*/STPoint3(0.f,0.f,5.f),STColor3f(1.f,1.f,1.f));
    ...
    rtPointLight(/*location*/STPoint3(4.f,-3.f,5.f),STColor3f(.5f,.5f,.5f));
//    rtDirectionalLight
...
//	Material mat_sphere(/*ambient*/STColor3f(1.f,1.f,1.f),/*diffuse*/STColor3f(0.f,1.f,0.f),/*specular*/STColor3f(0.f,0.f,0.f),/*mirror*/STColor3f(0.f,0.f,0.f),/*shiness*/0.f);
    ...
    Material mat_sphere(/*ambient*/STColor3f(0.f,0.f,1.f),/*diffuse*/STColor3f(0.f,0.f,0.8f),/*specular*/STColor3f(1.f,1.f,1.f),/*mirror*/STColor3f(0.f,0.f,0.f),/*shiness*/30.f);
...
void ExampleScene::initializeSceneBasicLightingAndShading()
{
	...
	rtMaterial(mat_sphere);
	rtSphere(STPoint3(-.5f,2.0f,1.f),1.f);


    
    ////box
	Material mat_box(/*ambient*/STColor3f(1.f,1.f,1.f),/*diffuse*/STColor3f(0.3f,0.5f,1.f),/*specular*/STColor3f(0.f,0.f,0.f),/*mirror*/STColor3f(0.f,0.f,0.f),/*shiness*/0.f);
	rtMaterial(mat_box);
	rtBox(STPoint3(-2.2f,-1.2f,0.f),STVector3(2.f,2.f,2.f));
...
void ExampleScene::initializeSceneTransform()
{
	...
	////global settings
	rtCamera(/*eye*/STPoint3(1.f,1.f,10.f),/*up*/STVector3(0.f,1.f,0.f),/*lookat*/STPoint3(0.f,0.f,0.f),/*fov*/45.f,/*aspect*/1.f);
...
void ExampleScene::initializeSceneAccelerationStructureGrid()
{
    ...
    rtCamera(/*eye*/STPoint3(0.f,-10.f,20.f),/*up*/STVector3(0.f,1.f,0.f),/*lookat*/STPoint3(0.f,0.f,5.f),/*fov*/60.f,/*aspect*/1.f);
	...
	rtPointLight(STPoint3(0.f,-10.f,15.f),STColor3f(.6f,.6f,.6f));
    ...
    for(int i=0;i<counts[0];i++){
        for(int j=0;j<counts[1];j++){
            for(int k=0;k<counts[2];k++){
                ...
                STColor3f green(0.527f,0.824f,0.484f);
                STColor3f red(0.75f,0.2226f,0.1679f);
                Material mat(color,color,STColor3f(),STColor3f(),40.f);
                Material mat_green(green,green,STColor3f(),STColor3f(),40.f);
                Material mat_red(red,red,STColor3f(),STColor3f(),40.f);
                ...
                Material mat_glass(/*ambient*/STColor3f(1.f,1.f,1.f),/*diffuse*/STColor3f(1.f,1.f,1.f),/*spec*/STColor3f(1.f,1.f,1.f),/*mirror*/STColor3f(0.f,0.f,0.f),/*shiness*/0.5f,/*refr*/STColor3f(.9f,.3f,.1f),/*sn*/1.3f);
                Material mat_metal(/*ambient*/STColor3f(0.3875f,.3308f,.2817f),/*diffuse*/STColor3f(0.3875f,.3308f,.2817f),/*spec*/STColor3f(.2f,.2f,.2f),/*mirror*/STColor3f(0.3875f,.3308f,.2817f),/*shiness*/10.f);
                Material mat_mirror(/*ambient*/STColor3f(1.f,1.f,1.f),/*diffuse*/STColor3f(.0f,.0f,.0f),/*spec*/STColor3f(.0f,.0f,.0f),/*mirror*/STColor3f(.9f,.9f,.9f),/*shiness*/0.f);
                rtPushMatrix();
                ...
                switch(mode){
                    case 0:
                        rtMaterial(mat_green);
                        rtScale(0.6f,0.6f,0.6f);
                        rtTriangleMesh("../Standard_Tests/android.obj",true,false);
                        count++;
                        break;
                    case 1:
                        rtMaterial(mat_red);
                        rtScale(.9f,.9f,.9f);
                        rtTriangleMesh("../Standard_Tests/apple.obj",true,false);
                        count++;
                        break;
                }
                //  rtTriangleMeshWithMaterialAndTexture("../Standard_Tests/DiningRoomSet/DiningRoomSet.obj", true, true);
                rtPopMatrix();
            }
        }
...
//	rtCamera(/*eye*/STPoint3(0.f,0.f,30.f),/*up*/STVector3(0.f,1.f,0.f),/*lookat*/STPoint3(0.f,0.f,0.f),/*fov*/60.f,/*aspect*/1.f);
    rtCamera(/*eye*/STPoint3(0.f,-30.f,10.f),/*up*/STVector3(0.f,1.f,0.f),/*lookat*/STPoint3(0.f,0.f,5.f),/*fov*/60.f,/*aspect*/1.f);
...
//    rtPointLight(STPoint3(0.f,0.f,10.f),STColor3f(1.f,1.f,1.f));
    ...
    centers.push_back(STPoint3(5.f,3.f,0.f));

	int counts[3]={10,10,10};
	float size[3]={5.f,5.f,5.f};
    int count = 0;
...
void ExampleScene::initializeAssignment4()
{
	rtClear();
    
	////global settings
	rtCamera(/*eye*/STPoint3(10.f,5.f,19.f),/*up*/STVector3(0.f,1.f,0.f),/*lookat*/STPoint3(10.f,3.f,0.f),/*fov*/45.f,/*aspect*/1.33f);
	rtOutput(/*width*/640,/*height*/480,/*path*/"../Standard_Tests/AObject.png");
	rtBounceDepth(5);
	rtUseTransparentShadow(true);
	rtShadowBias(.001f);
	rtSampleRate(1);
...
//	rtAreaLight(/*v1*/STPoint3(1.5f,.25f,.75f),/*v2*/STPoint3(1.5f,-.25f,1.25f),/*v3*/STPoint3(1.5f,.25f,1.25f),STColor3f(.8f,.8f,.8f));
	...
	Material mat_glass1(/*ambient*/STColor3f(),/*diffuse*/STColor3f(),/*spec*/STColor3f(0.f,0.f,0.f),/*mirror*/STColor3f(0.f,0.f,0.f),/*shiness*/0.f,/*refr*/STColor3f(.9f,.3f,.1f),/*sn*/1.3f);
	Material mat_glass2(/*ambient*/STColor3f(.1f,.1f,.1f),/*diffuse*/STColor3f(),/*spec*/STColor3f(0.5f,0.5f,0.5f),/*mirror*/STColor3f(.2f,.2f,.2f),/*shiness*/30.f,/*refr*/STColor3f(.7f,.6f,.9f),/*sn*/1.2f);
    Material mat_metal(/*ambient*/STColor3f(0.3875f,.3308f,.2817f),/*diffuse*/STColor3f(0.3875f,.3308f,.2817f),/*spec*/STColor3f(.2f,.2f,.2f),/*mirror*/STColor3f(0.3875f,.3308f,.2817f),/*shiness*/10.f);
    Material mat_mirror(/*ambient*/STColor3f(1.f,1.f,1.f),/*diffuse*/STColor3f(.2f,0.2f,0.2f),/*spec*/STColor3f(.2f,.2f,.2f),/*mirror*/STColor3f(.9f,.9f,.9f),/*shiness*/0.f);
    ...
    rtMaterial(mat_metal);
    rtPushMatrix();
	rtTranslate(13.f,0.0f,5.f);     //z is front and back
	rtScale(.02f,.02f,.02f);
	rtTriangleMesh("../Standard_Tests/angel.obj",true,false);
	rtPopMatrix();
    ...
    rtPushMatrix();
	rtTranslate(13.f,5.2f,2.f);     //z is front and back
	rtScale(.1f,.1f,.1f);
	rtTriangleMesh("../Standard_Tests/mirror.obj",true,false);
	rtPopMatrix();
    
    
	////environment box

    Material mat_ground(STColor3f(1.f, 1.f, 1.f), STColor3f(1.f, 1.f, .796f), STColor3f(), STColor3f(), 0.f);
    Material mat_wall(STColor3f(1.f, 1.f, 1.f), STColor3f(1.f, .56f, .796f), STColor3f(), STColor3f(), 30.f);
	rtMaterial(mat_ground);
	////ground
	addGround(STPoint3(0.f,0.f,0.f),STVector2(20.f,20.f),true);
	rtMaterial(mat_wall);
    ...
    //smoke
    Material participating_medium(STColor3f(.6f,.6f,.6f),STColor3f(0.f,0.f,.6f),STColor3f(0.5f,0.5f,0.5f),STColor3f(0.5f,0.5f,0.5f),0.5f);
...
//    ////global settings
//    //oriignal::
//    //rtCamera(/*eye*/STPoint3(10.f, 10.f, 39.f)/*(13.f, 15.f, 30.f)*/,/*up*/STVector3(0.f, 1.f, 0.f),/*lookat*/STPoint3(10.f, 10.f, 0.f)/*(10.f, 3.f, 0.f)*/,/*fov*/45.f,/*aspect*/1.f);
//    rtCamera(STPoint3(10.f, 4.5f, 21.f), STVector3(0.f, 1.f, 0.f), STPoint3(10.f, 4.5f, 20.f), 55.f, 1.f);
//    rtOutput(/*width*/512,/*height*/512,/*path*/"../Standard_Tests/Assignment7.png");
//    rtBounceDepth(5);
//    rtUseTransparentShadow(true);
//    rtShadowBias(1e-4f);
//    rtSampleRate(5);
...
//    rtMaterial(mat_metal);
//    rtPushMatrix();
//    rtTranslate(13.f,0.0f,8.f);     //z is front and back
//    rtScale(.02f,.02f,.02f);
//    rtTriangleMesh("../Standard_Tests/angel.obj",true,false);
//    rtPopMatrix();
//    
...
//    rtMaterial(mat_ground);
//    int tex_id;
//    rtLoadTexture("../Standard_Tests/stanford.png", tex_id);
//    ////ground
//    addGround(STPoint3(0.f, 0.f, 0.f), STVector2(20.f, 40.f), true);
//    ////ceil
//    addGround(STPoint3(0.f, 20.f, 0.f), STVector2(20.f, 40.f), false);
//    
//    rtMaterial(mat_wall);
...
//    addBackgroundWall(STPoint3(0.f, 0.f, 0.f), STVector2(20.f, 20.f), true);
//    ////left wall
//    addWall(STPoint3(0.f, 0.f, 0.f), STVector3(0.f, 20.f, 0.f), STVector3(0.f, 0.f, 40.f), true);
//    ////right wall
//    addWall(STPoint3(20.f, 0.f, 0.f), STVector3(0.f, 20.f, 0.f), STVector3(0.f, 0.f, 40.f), false);
//    
////    rtSetApeture(60.f);
////    //rtSetFocus(STPoint3(13.f,0.0f,-4.f));
////    rtSetFocus(STPoint3(13.f,0.0f,8.f));
////    
//    
//    ////set focus on sphere 3
//    // rtSetApeture(10.f);
//    // rtSetFocus(STPoint3(10.f, 10.f, 35.f));
//    // rtUnbindTexture();
//    int flag = 1;
//    if (flag == 1) {
//        ////use acceleration structure
...
//    STPoint3 p(8.f, 3.5f, 4.5f);
//    STPoint3 p1=p;p1.x+=5.f;
//    STPoint3 p2=p;p2.y+=5.f;
//    STPoint3 p3=p;p3.z+=5.f;
//    
//    rtBox(p,p1,p2,p3);

    //SMOG
//    STPoint3 q(7.f, 2.5f, 11.5f);
//    STPoint3 q1=q;q1.x+=5.f;
//    STPoint3 q2=q;q2.y+=5.f;
//    STPoint3 q3=q;q3.z+=5.f;
//    
//    rtBox(q,q1,q2,q3);
